    ...
    public function upsert(Request $request)
    {
        ...
        $allow = [
            'print' => [
                ...
                'artwork_reminder_color',
                'material_record_status',
                'material_record_color',
                'artwork_done_status',
                'artwork_done_color',
                'send_chop_sign_status',
                'send_chop_sign_color',
                'chop_sign_approval_status',
                'chop_sign_approval_color',
                'park_in_file_server_status',
                'park_in_file_server_color',
            ],
            ...
            'video' => [
                ...
                'artwork_reminder_status',
                'artwork_reminder_color',
                'material_reminder_text_status',
                'material_reminder_text_color',
                'material_record_status',
                'material_record_color',
                'video_done_status',
                'video_done_color',
                ...
                'video_approved_color',
                'video_scheduled_status',
                'video_scheduled_color',
                'video_posted_status',
                'video_posted_color',  // ← INI YANG KURANG!
                'post_link_status',
                'post_link_color',
            ],
            ...
            'article' => [
                ...
                'article_approved_color',
                'article_scheduled_status',
                'article_scheduled_color',
                'article_posted_status',
                'article_posted_color',
                'post_link_status',
                'post_link_color',
                'blog_link_status',
                'blog_link_color',
